    ...
    <div class="modal fade" id="nuevoDescuento" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content-mio">
                <form action="../php/nuevoDescuento.php?tipo=descuento" method="post">
                    <div class="sectionPorcentaje">
                        <label for="codigo">Código:</label>
                        <input type="text" name="codigo" class="form-control inputVariaciones" id="codigo">
                        <label for="porcentaje">Porcentaje (sin signo):</label>
    ...
    <div class="wrapper">
        ...
        <main class="mainAdmin">
            ...
            <ul>
                ...
                <li class="opciones"><a href="descuento.php" class="btn btn-mi-color-select">Códigos descuentos</a></li>
            </ul>
                    ...
                    <table class="table align-middle mb-0 bg-white">
                        ...
                        <tbody>
                            <?php
                                ...
                                $query = "SELECT * FROM giftcards WHERE tipo = 'descuento' ORDER BY id DESC";
                                ...
                                while ($fila = mysqli_fetch_assoc($res)) {
                                    ...
                                    echo "<td><a class='btn btn-mi-danger eliminar' href='../php/deleteDiscount.php?deleteid=" . $id . "&tipo=descuento'>Eliminar</a></td>";
                                    echo "</tr>";
