...
<body>
    ...
    <div class="wrapper">
        ...
        <main class="mainInfo">
            ...
            <div>
                <h3>Número de pedido: <span id="pedido"><?php echo $id_pedido; ?></span></h3>
            ...
            if($tipo != "Local") {
                echo '<div>
                <label for="seguimiento" class="form-label">Código de seguimiento:</label>
                <input type="text" id="seguimiento" class="form-control">
                <label for="envio" class="form-label">Costo de envío:</label>
                <input type="text" id="envio" class="form-control">
                <input type="submit" value="Enviar" class="btn btn-mi-color" id="botonEnviar">
            </div>';
            }else{
                echo '<input type="submit" value="Retirar" class="btn btn-mi-color" id="botonEnviarLocal">';
            } 
            ?>
        </main>
    </div>
