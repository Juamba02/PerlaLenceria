<?php
    ...
    $categoria = mysqli_real_escape_string($connection, $categoria);
?>
...
<head>
    ...
    <title><?php echo $categoria; ?> - Perla Lencería</title>
...
<body>
    <div class="wrapper">
        ...
        <main>
            ...
            <h2 class="titulo"><?php echo $categoria; ?></h2>
                ...
                <?php
                    ...
                    if(mysqli_num_rows($resultado) > 0) {
                        while($fila = mysqli_fetch_assoc($resultado)) {
                            echo "<a href='producto?id=" . $fila['id'] . "'>";
